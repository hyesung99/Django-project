...
from .views import base_views, comment_answer_views, comment_question_views, question_views, answer_views, vote_views
...
urlpatterns = [
    ...
    path('vote/question/cancel/<int:question_id>/', vote_views.vote_question_cancel, name='vote_question_cancel'),
